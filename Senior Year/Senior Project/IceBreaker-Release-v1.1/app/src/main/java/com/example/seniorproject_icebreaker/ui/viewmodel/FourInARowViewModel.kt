...
class FourInARowViewModel : ViewModel() {
    ...
    fun checkName(currentUserEmail: String, friendEmail: String) {
        viewModelScope.launch(Dispatchers.IO) {
            try {
                ...
                Log.e("FourInARowViewModel", "Error checking name: $e.message", e)
            }
        }
    }
    ...
    fun checkStartDate(currentUserEmail: String, friendEmail: String) {
        viewModelScope.launch(Dispatchers.IO) {
            try {
                ...
                // Log error or handle it appropriately
                Log.e("FourInARowViewModel", "Error checking start date: $e.message", e)
            }
        }
    }
    ...
    fun checkPlayers(currentUserEmail: String, friendEmail: String) {
        viewModelScope.launch(Dispatchers.IO) {
            try {
                ...
                // Log error or handle it appropriately
                Log.e("FourInARowViewModel", "Error checking players: $e.message", e)
            }
        }
    }
    ...
    fun checkBoxStates(currentUserEmail: String, friendEmail: String) {
        viewModelScope.launch(Dispatchers.IO) {
            try {
                ...
                // Log error or handle it appropriately
                Log.e("FourInARowViewModel", "Error checking box states: $e.message", e)
            }
        }
    }
    ...
    fun checkTurn(currentUserEmail: String, friendEmail: String) {
        viewModelScope.launch(Dispatchers.IO) {
            try {
                ...
                // Log error or handle it appropriately
                Log.e("FourInARowViewModel", "Error checking turn: $e.message", e)
            }
        }
    }
    ...
    fun checkWinner(currentUserEmail: String, friendEmail: String) {
        viewModelScope.launch(Dispatchers.IO) {
            try {
                ...
                // Log error or handle it appropriately
                Log.e("FourInARowViewModel", "Error checking winner: $e.message", e)
            }
        }
    }
    ...
    fun checkData(currentUserEmail: String, friendEmail: String) {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                ...
                Log.e("FourInARowViewModel", "Error checking data: $e")
            } finally {
