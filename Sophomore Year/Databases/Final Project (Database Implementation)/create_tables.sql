...
CREATE TABLE Salad_T (
    ...
    Dressing VARCHAR2(10) CHECK(Dressing IN ('Ranch', 'Italian', 'Caesar')),
    Price NUMBER(3,0) NOT NULL,
...
CREATE TABLE Sandwich_T (
    ...
    LittleEatalyID INTEGER NOT NULL,
    OrderID INTEGER NOT NULL,
    Meat VARCHAR2(10) CHECK(Meat IN ('Turkey', 'Ham', 'Beef')),
    Cheese VARCHAR2(10) CHECK(Cheese IN ('American', 'Swiss', 'Cheddar')),
    Sauce VARCHAR2(10) CHECK(Sauce IN ('Mayonnaise', 'Mustard', 'Ketchup')),
...
CREATE TABLE Dessert_T (
    ...
    LittleEatalyID INTEGER NOT NULL,
    OrderID INTEGER NOT NULL,
    DessertSize VARCHAR2(10) CHECK (DessertSize IN ('Small', 'Medium', 'Large')) NOT NULL,
    Flavor VARCHAR(10) CHECK (Flavor IN ('Vanilla', 'Chocolate', 'Strawberry')) NOT NULL,
    WhippedCream VARCHAR(3) CHECK (WhippedCream IN ('Yes', 'No')) NOT NULL,
    Syrup VARCHAR(10) CHECK (Syrup IN ('Yes', 'No')) NOT NULL,
    Price NUMBER(3,0) NOT NULL,
