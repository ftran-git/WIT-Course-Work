...
The R-Squared value for the Income Regression Model is 0.215 therefore it means approximately 21 percent of the variance of Balance is explained by the variance of Income. 

The R-Squared value for the Limit Regression Model is 0.7425 therefore it means approximately 74 percent of the variance of Balance is explained by the variance of Limit.

The R-Squared value for the Rating Regression Model is 0.7458 therefore it means approximately 74 percent of the variance of Balance is explained by the variance of Rating.
